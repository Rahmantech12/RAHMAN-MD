    ...
    try {
        ...
        for (const item of response.data.data) {
            await conn.sendMessage(from, {
                ...
                caption: `‎*_ʀᴀʜᴍᴀɴ-ᴍᴅ ɪɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ_*
‎*╭──────────────━┈⍟*
...
cmd({
  ...
  try {
    ...
    if (!response.data?.status || !response.data?.BK9?.[0]?.url) {
      await conn.sendMessage(from, { react: { text: '❌', key: m.key } });
      return reply('❌ Unable to fetch the video. Try .igdl4 for primary download.');
    }
...
cmd({
  ...
  try {
    ...
    await reply('*_Rαнмαη-м∂ υρℓσα∂ιηg үσυʀ vι∂εσ_*⤵️');

    await conn.sendMessage(from, {
      video: { url: videoUrl },
      caption: `‎*╭┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉━┈⍟*
‎*┋* *_ʀᴀʜᴍᴀɴ-ᴍᴅ ɪɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ_* 
‎*┋┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉━•⟢*
‎*┋▸* 👤 *_ᴀᴜᴛʜᴏʀ: ${author}_*
‎*┋▸* ❤️ *_ʟɪᴋᴇs: ${likes}_*
‎*┋▸* 💬 *_ᴄᴏᴍᴍᴇɴᴛs: ${comments}_*
‎*╰┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉━┈⍟*
‎‎*╭┉┉┉┉◉◉◉┉┉┉┉┉┉┉━┈៚*
‎*┋* *_ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʀᴀʜᴍᴀɴ-ᴍᴅ_* 
‎*╰┉┉┉┉◉◉◉┉┉┉┉┉┉┉━┈៚*`
