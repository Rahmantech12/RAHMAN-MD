...
cmd(
    ...
    async (conn, mek, m, { quoted, args, q, reply, from }) => {
        try {
            ...
            await reply(`🔍 *ʀαнмαη-м∂ sεαʀcнιηg* ${packName}\n⏳ *‎ωαιт...*`);
            ...
            try {
                ...
                // Final result
                const resultMessage = `*ʀᴀʜᴍᴀɴ-ᴍᴅ sᴛɪᴄᴋᴇʀ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ*\n\n📦 *ᴘᴀᴄᴋ:* ${stickerSet.title}\n✅ *sᴜᴄᴄᴇss:* ${successCount}/${totalStickers} sᴛɪᴄᴋᴇʀs\n*_ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʀᴀʜᴍᴀɴ-ᴍᴅ_*`;
