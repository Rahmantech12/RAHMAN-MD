...
async function loadSession() {
    try {
        ...
        const sessionString = config.SESSION_ID.startsWith('RAHMAN-MD~')
...
// When a user visits the root URL ('/'), send them the rahman.html file
app.get('/', (req, res) => {
  res.sendFile(path.join(__dirname, 'assets', 'rahman.html'));
});
